...
// surface the five main rooms so they can re-orient with one click. The
// Fraunces headline matches the rest of the app's hero moments.
//
// Server Component — no state, no JS.
// Header is a client component but can be rendered inside a server component
