        ...
        <section className="rounded-[var(--r-lg)] border-2 border-[var(--brand-strong)] bg-[linear-gradient(135deg,var(--brand-soft)_0%,var(--surface-elevated)_100%)] p-6 sm:p-8 space-y-5 print:hidden">
          ...
          <div className="grid sm:grid-cols-3 gap-3 pt-2">
            <UpsellCard
              ...
              body="Drafts for every channel — captions, posts, newsletters, carousels. A library of past pieces you can repurpose. Pillar-driven topic suggestions from your Brand OS."
            />
            <UpsellCard
              eyebrow="Leads"
