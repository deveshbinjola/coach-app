...
const SIGNAL: Question[] = [
  {
    ...
    order: 1,
    kind: "pasteBlock",
    prompt: "Paste 3–5 of your own writing pieces that you loved writing.",
    hint: "Label each by container — caption, newsletter, DM, post. We're looking for 'that's me at my best.' Voice samples are not optional; we block if you skip.",
    placeholder: "[CAPTION] …\n\n[NEWSLETTER] …\n\n[POST] …",
    minChars: 200,
